    ...
    var promise = new Promise(function (resolve) {
        ...
        free.stdout.on('data', function (data) {
            var lines = data.toString().split(/\n/g),
                ...
                // free versions 3.3.10 and above don't display -/+ buffers/cache line.
                swapTotal = line3.length > 1 ? parseInt(line3[1], 10) : parseInt(line2[1], 10),
                swapUsed = line3.length > 1 ? parseInt(line3[2], 10) : parseInt(line2[2], 10),
                swapFree = line3.length > 1 ? parseInt(line3[3], 10) : parseInt(line2[3], 10),
                memory = {
                    total: total,
